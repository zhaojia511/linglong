...
class _HomeScreenState extends State<HomeScreen> {
  ...
  late final List<Widget> _screens = [
    ...
    // Settings screen added to the main tab bar
    // Imported lazily to avoid import cycles; ensure file exists
    // We'll import SettingsScreen at top
    // replace with actual instance below
  ];
