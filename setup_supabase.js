...
const supabaseUrl = 'https://krbobzpwgzxhnqssgwoy.supabase.co'
const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImtyYm9ienB3Z3p4aG5xc3Nnd295Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjcyNDM1OTEsImV4cCI6MjA4MjgxOTU5MX0.4z4gEpUdVahjHfmSCiyTEaPS_vWljX9zzjKSi_Gm99E'
...
async function setup() {
  ...
  try {
    ...
    if (error) {
      ...
      console.log('\nNote: The anon key cannot run DDL commands. You need the service_role key.')
      console.log('Please run the SQL manually in Supabase SQL Editor:')
      console.log('https://krbobzpwgzxhnqssgwoy.supabase.co/project/_/sql')
      process.exit(1)
    }
