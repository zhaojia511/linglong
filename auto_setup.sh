...
open "https://supabase.com/dashboard/project/krbobzpwgzxhnqssgwoy/sql/new"

echo ""
echo "📝 Steps:"
echo "1. The SQL is already copied to your clipboard"
echo "2. Paste it (Cmd+V) in the SQL Editor that just opened"
echo "3. Click 'Run' button"
echo "4. Refresh your web app"
echo ""
